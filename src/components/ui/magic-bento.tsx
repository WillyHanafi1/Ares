...
const DEFAULT_CARDS: BentoCardItem[] = [
  ...
  },
  {
    ...
    description: 'Tutup buku dalam menit. Proses yang dulunya berjam-jam kini selesai sendiri — tim finance fokus analisis, bukan salin-tempel angka.',
    label: 'FinTech',
    icon: '🏦',
  },
  {
    ...
    description: 'Hubungkan 500+ aplikasi dan buat workflow berjalan sendiri — sinkronisasi data, laporan otomatis, notifikasi cerdas. Bahkan saat kamu sedang tidur.',
    label: 'Automation',
    icon: '🔄',
  },
  {
  ...
  },
  {
    ...
    description: 'Model AI yang dilatih khusus untuk bisnis kamu — dari data kamu, untuk masalah kamu.',
    label: 'AI',
    icon: '✨',
  },
];
